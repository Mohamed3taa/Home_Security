...
class MaterialTheme {
  ...
  static ColorScheme lightMediumContrastScheme() {
    return const ColorScheme(
      ...
      primaryFixedDim: Color(0xff455288),
  ...
  static ColorScheme lightHighContrastScheme() {
    return const ColorScheme(
      ...
      surfaceTint: Color(0xff4f5b92),
      onPrimary: Color(0xffffffff),
      primaryContainer: Color(0xff39467b),
      onPrimaryContainer: Color(0xffffffff),
      ...
      onTertiary: Color(0xffffffff),
      tertiaryContainer: Color(0xff5f3f59),
      onTertiaryContainer: Color(0xffffffff),
      ...
      onSecondaryFixedVariant: Color(0xffffffff),
      tertiaryFixed: Color(0xff5f3f59),
      onTertiaryFixed: Color(0xffffffff),
  ...
  static ColorScheme darkMediumContrastScheme() {
    return const ColorScheme(
      ...
      primaryFixed: Color(0xffdde1ff),
      onPrimaryFixed: Color(0xff000b3b),
      primaryFixedDim: Color(0xffb8c4ff),
      onPrimaryFixedVariant: Color(0xff253267),
      secondaryFixed: Color(0xffdee1f9),
  ...
  static ColorScheme darkHighContrastScheme() {
    return const ColorScheme(
      ...
      primaryContainer: Color(0xffb3c0fd),
      onPrimaryContainer: Color(0xff00072d),
      ...
      primaryFixedDim: Color(0xffb8c4ff),
      onPrimaryFixedVariant: Color(0xff000b3b),
      secondaryFixed: Color(0xffdee1f9),
